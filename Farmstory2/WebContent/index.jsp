    ...
    <div class="latest">
        <div>
            ...
            <table border="0">
                ...
                <tr>
                    <td>></td>
                    <td><a href="/Farmstory2/board/view.do?seq=${vo.seq}&group=croptalk&cate=grow">${vo.title}</a></td>
                    <td>${vo.rdate}</td>
                </tr>
                </c:forEach>
        ...
        <div>
            ...
            <table border="0">
               ...
               <c:forEach var="vo" items="${latest2}">
                <tr>
                    <td>></td>
                    <td><a href="/Farmstory2/board/view.do?seq=${vo.seq}&group=croptalk&cate=school">${vo.title}</a></td>
                    <td>${vo.rdate}</td>
                </tr>
                </c:forEach>
        ...
        <div>
            ...
            <table border="0">
              ...
              <c:forEach var="vo" items="${latest3}">
                <tr>
                    <td>></td>
                    <td><a href="/Farmstory2/board/view.do?seq=${vo.seq}&group=croptalk&cate=croptalk">${vo.title}</a></td>
                    <td>${vo.rdate}</td>
                </tr>
                </c:forEach>
            </table>
